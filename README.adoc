...
Or manually grab the https://github.com/okabsd/env[source].

== Documentation

=== The module

`env` as a module fairly simple - most of the complexity arises from understanding _how_ environments in Lua work, and _when_ it is appropriate to use them. Make sure you read up on them in the https://www.lua.org/manual/5.4/manual.html#2.2[Lua Reference Manual].
...
https://raw.githubusercontent.com/okabsd/env/master/LICENSE[MIT], just like Lua.
